...
const translations = {
    ...
    fr: {
        ...
        hero_subtitle: "0% Frais • Serveurs Globaux • SSL • PPLNS",
        ...
        why_subtitle: "La pool Monero globale conçue pour les mineurs",
        why_low_latency: "Faible Latence",
        why_low_latency_desc: "Serveurs globaux (EU & US) pour un ping optimal et des soumissions plus rapides",
        ...
        about_text: "EuroXMR est gérée par des mineurs indépendants dédiés à la décentralisation. Nous avons des nœuds en Europe et aux USA.",
        independent_miner: "Pool opérée par des mineurs indépendants",
        contact_title: "Contact & Support",
        ...
        footer_tagline: "Pool de Minage Monero Globale",
    ...
    de: {
        ...
        hero_subtitle: "Gebührenfreier, sicherer PPLNS-Pool (Global).",
        why_subtitle: "Der globale Monero Pool für Miner",
        why_low_latency_desc: "Globale Server (EU & US) für optimalen Ping",
    ...
    es: {
        ...
        hero_subtitle: "Pool PPLNS seguro y global sin comisiones.",
        why_subtitle: "El pool Monero global para mineros",
        why_low_latency_desc: "Servidores globales (EU & US) para ping óptimo",
    ...
    ru: {
        ...
        hero_subtitle: "Надежный глобальный PPLNS пул без комиссии.",
        why_subtitle: "Глобальный пул Monero для майнеров",
        why_low_latency_desc: "Глобальные серверы (EU & US) для оптимального пинга",
